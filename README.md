...
Отображает статистику написанных постов на форуме <ru-minecraft.ru/forum> в виде нескольких таблиц с парой настроек.
...
## Газета Румайности
Газета вышеупомянутого сайта <ru-minecraft.ru> обосновалась именно здесь после перехода на новый формат. Пока что в наличии имеется один выпуск за 2019 год, но вполне возможен перенос и предыдущих. И даже добавление новых.
