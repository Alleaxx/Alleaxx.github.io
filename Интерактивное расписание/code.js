...
const subjects = {
    ...
    2:[
        [
            {name:'Русский язык и культура речи',cab:'У-318',type:'ПЗ',prep:'Крылова Н.Ф.'},
            0
        ],
        [
            {name:'Проектный практикум',cab:'ЛК-117',type:'ЛЗ',prep:'Шевченко М.О.'},
            {name:'Проектный практикум',cab:'ЛК-117',type:'ЛЗ',prep:'Шевченко М.О.'},
        ],
        [
        ...
        [
            {name:'Проектный практикум',cab:'ЛК-223',type:'Л',prep:'Шевченко М.О.'},
            0
        ]
    ...
    3:[
        [
            {name:'Менеджмент IT-проектов',cab:'ЛК-232',type:'ЛЗ',prep:'Блинникова А.В.'},
            {name:'Менеджмент IT-проектов',cab:'ЛК-232',type:'ЛЗ',prep:'Блинникова А.В.'},
        ],
        [
            {name:'Менеджмент IT-проектов',cab:'ЛК-232',type:'ЛЗ',prep:'Блинникова А.В.'},
            {name:'Решения 1С для бизнеса',cab:'ЛК-101',type:'ЛЗ',prep:'Показаньев В.Ю.'}
        ],
        [
    ...
    4:[
        ...
        [
            {name:'Менеджмент IT-проектов',cab:'ЛК-232',type:'Л',prep:'Блинникова А.В.'},
            {name:'Менеджмент IT-проектов',cab:'ЛК-232',type:'ЛЗ',prep:'Блинникова А.В.'}
        ],
    ...
    5:[
        ...
        [
            {name:'Web-программирование',cab:'ЛК-223',type:'Л',prep:'Макаренко А.Е.'},
            {name:'Web-программирование',cab:'ЛК-223',type:'Л',prep:'Макаренко А.Е.'}
        ],
        [
            0,
            {name:'Физкультура',cab:'акт-зал',type:'Лекция',prep:''}
        ]
    ],
    6:[
        [
