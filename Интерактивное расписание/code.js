...
const subjects = {
    ...
    2:[
        [0,0],
        [
            {name:'Предметно-ориентированные эк. инф. системы',cab:'ЛК-418',type:'Л',prep:'Показаньев'},
            {name:'Интеллектуализация инф. систем',cab:'ЛК-232',type:'Л',prep:'-'}
        ],
        [
            {name:'Предметно-ориентированные эк. инф. системы',cab:'ЛК-418',type:'ПЗ',prep:'Показаньев'},
            {name:'Предметно-ориентированные эк. инф. системы',cab:'ЛК-418',type:'ПЗ',prep:'Показаньев'},
        ],
        [
            {name:'Интеллектуализация инф. систем',cab:'ЛК-107',type:'ПЗ',prep:'-'},
            {name:'Интеллектуализация инф. систем',cab:'ЛК-107',type:'ПЗ',prep:'-'}
        ],
    ...
    3:[
        ...
        [
            {name:'Распр. системы и облачные вычисления',cab:'ЛК-102',type:'ЛЗ',prep:'-'},
            {name:'Распр. системы и облачные вычисления',cab:'ЛК-102',type:'ЛЗ',prep:'-'}
        ],
        [0,0]
    ],
    4:[
        ...
        [
            {name:'Корпоративные инф. системы',cab:'БЦ-217',type:'Л',prep:'Терехова'},
            {name:'Корпоративные инф. системы',cab:'БЦ-217',type:'Л',prep:'Терехова'}
        ],
        [
            {name:'Корпоративные инф. системы',cab:'БЦ-217',type:'ЛЗ',prep:'Терехова'},
            {name:'Корпоративные инф. системы',cab:'БЦ-217',type:'ЛЗ',prep:'Терехова'}
        ],
    ...
    5:[
        ...
        [
            {name:'Компьютерная графика и программирование игр',cab:'ЛК-223',type:'Л',prep:'Якунина'},
            {name:'Компьютерная графика и программирование игр',cab:'ЛК-223',type:'Л',prep:'Якунина'}
        ]
    ],
    6:[
